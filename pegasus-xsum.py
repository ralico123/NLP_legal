...
train_df = pd.read_parquet("hf://datasets/FiscalNote/billsum/" + splits["train"])[['text', 'summary']][:200]
val_df = pd.read_parquet("hf://datasets/FiscalNote/billsum/" + splits["test"])[['text', 'summary']][:50]
